...
float RPM_max = 230;         // Setting up a safe maximum RPM for the Motor

//******************************MISC VARIABLES*****************
#define pi 3.1416
//Maximum motor voltage in clockwise rotation
float Vmax = 9;      // Check Motor Datasheet
//Minimum motor voltage
float Vmin = 0;
float V = 7;         // Motor voltage input. Set voltage to step amplitud 
